...
export default function OTPForm({ value, onChange }) {
  return (
    <Box sx={{ display: "flex", flexDirection: "column" }}>
      <OTP value={value} onChange={onChange} length={4} />
    </Box>
  );
}
const blue = {
 ...
 width: 80%;
  ...
  &:focus {
    ...
    box-shadow: 0 0 0 3px ${
      theme.palette.mode === "dark" ? blue[600] : blue[50]
    };
  }
